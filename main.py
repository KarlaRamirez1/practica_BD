...
from PySide6.QtWidgets import QApplication, QMainWindow, QLineEdit, QMessageBox, QTableWidgetItem, QFileDialog

from Modules.login import Login
from Modules.main_ui import Ui_MainWindows
from Modules.db.conexion import conexion,respaldo,restaurar
...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		this.donwload.clicked.connect(respaldo)
		this.upload.clicked.connect(restaurar)
